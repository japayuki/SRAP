              ...
              <v-card>
                ...
                <v-data-table
                  ...
                  <template slot="items" scope="props">
                    <td class="text-xs-left"><router-link style="font-size:14px" class="deep-orange--text text--darken-2" v-bind:to="'/profile/'+props.item._id">{{ props.item.memberid }}</router-link></td>
